package by.uladzimirmakei.textseparator.service.writer.impl;

import by.uladzimirmakei.textseparator.repository.entity.TextComposite;
import by.uladzimirmakei.textseparator.service.writer.TextUnitWriter;
    ...
    public void write(TextComposite input) {
        try (PrintWriter writer = new PrintWriter(
            ...
            logger.log(Level.ERROR,
                    "Text unit writer unable to write data to file {} {}",
